function [ ASE_doneflag ] = ASEcheck_v6_fn( patdir, hctUncorr,sliceGrab,slice2grab,echo2Exclude,tauvec,TR,TE1,TE2,excludedyns_1echo,excludedyns,B0,dcm2nii64_path,flirt_path,ASEresolution)
...
%         %%%%%%%%%% View auto-grabbed WM mask (3D)
%         for i=1:size(Imat,3)
%             temp=Imat.*~wmmask;
%             imagesc(temp(:,:,i,1,1)/maxval)
%             pause
%         end
%         %%%%%%%%%%%
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %%%%%% Full Model Fit! CALCULATE!!!
        if threeD && ~sliceGrab
...
%             imagesc(Imat(:,:,c))
%             hold on
%             plot(b,a,'r.','MarkerSize',16)
%             colormap gray
%             axis square
%             voxelwalkcount=voxelwalkcount+1;
%             if c==7
%                 figure
%             end
%             %%%%%%%%%
