function [ finflag ] = coreg2dto3d_v1(ase2dname,ase3dname,t1file,mni_brain,patdir,ASEresolution,dcm2nii64_path,flirt_path,bet2_path)
...
for i=1:length(files2d)
    ...
    ASE_coreg_slw_v1( input1, output1, nameParenthesisPreslasher(t1file), nameParenthesisPreslasher(ase2t1omat), 'use', dcm2nii64_path, flirt_path, ' -interp nearestneighbour ', bet2_path, '','', 0, 0 )
    input1=output1;
    output1=nameParenthesisPreslasher(newfile3d);
    ASE_coreg_slw_v1( input1, output1, nameParenthesisPreslasher(mni_brain), nameParenthesisPreslasher(t12mniomat), 'use', dcm2nii64_path, flirt_path, ' -interp nearestneighbour ', bet2_path, '','', 0, 0 )
end
